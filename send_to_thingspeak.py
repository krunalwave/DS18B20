#---------- Uploading Temperature Data to thingspeak IoT Plateform ------------------#
#
...
key = 'Your Thingspeak Write Key'                           #Your Thingspeak Write Key
...
while True:
    temp = read_temp()                                      # Print temperature
    print temp
    ...
    params=urllib.urlencode({'field1':temp_in_C,'field2':temp_in_F,'key':key})
